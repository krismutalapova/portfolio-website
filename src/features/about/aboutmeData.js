...
export const skills = [
    {
        name: 'JavaScript',
        icon: (
            <SiJavascript className="text-yellow-400" title="JavaScript" aria-label="JavaScript" />
        ),
        level: 90,
    },
    {
        name: 'TypeScript',
        icon: <SiTypescript className="text-blue-500" title="TypeScript" aria-label="TypeScript" />,
        level: 80,
    },
    {
        name: 'Python',
        icon: <FaPython className="text-yellow-500" title="Python" aria-label="Python" />,
        level: 60,
    },
    {
        name: 'Java',
    ...
    {
        name: 'React',
        icon: <FaReact className="text-blue-400" title="React" aria-label="React" />,
        level: 85,
    },
    {
        name: 'Redux',
        icon: <SiRedux className="text-purple-500" title="Redux" aria-label="Redux" />,
        level: 75,
    },
    {
        name: 'HTML5',
        icon: <FaHtml5 className="text-orange-500" title="HTML5" aria-label="HTML5" />,
        level: 95,
    },
    {
        name: 'CSS3',
        icon: <FaCss3Alt className="text-blue-500" title="CSS3" aria-label="CSS3" />,
        level: 90,
    },
    {
        name: 'Tailwind CSS',
    ...
    {
        name: 'Node.js',
        icon: <FaNodeJs className="text-green-600" title="Node.js" aria-label="Node.js" />,
        level: 80,
    },
    {
        name: 'Express',
        icon: <FaNodeJs className="text-gray-700" title="Express" aria-label="Express" />,
        level: 75,
    },
    {
        name: 'SQL',
    ...
    {
        name: 'MongoDB',
        icon: <SiMongodb className="text-green-700" title="MongoDB" aria-label="MongoDB" />,
        level: 70,
    },
    {
        name: 'Django',
        icon: <SiMongodb className="text-green-800" title="Django" aria-label="Django" />,
        level: 65,
    },
    {
        name: 'Docker',
        icon: <SiDocker className="text-blue-400" title="Docker" aria-label="Docker" />,
        level: 60,
    },
    {
        name: 'Jest',
    ...
    {
        name: 'REST APIs',
        icon: <FaNodeJs className="text-green-600" title="REST APIs" aria-label="REST APIs" />,
        level: 80,
    },
    {
        name: 'Agile/Scrum',
        icon: <SiJest className="text-green-500" title="Agile/Scrum" aria-label="Agile/Scrum" />,
        level: 80,
    },
    {
        name: 'Communication',
    ...
    {
        name: 'Teamwork',
        icon: <FaReact className="text-gray-500" title="Teamwork" aria-label="Teamwork" />,
        level: 90,
    },
    {
