    ...
    return (
        <section className="w-full bg-gray-100 dark:bg-gray-900 py-12 xl:py-20 flex items-center justify-center">
            <div className="w-full max-w-4xl px-4 xl:px-0 text-left">
                <h2 className="text-2xl md:text-3xl xl:text-4xl font-bold text-gray-800 dark:text-white mb-4 text-center">About Me</h2>
                ...
                <CollapsiblePanel title="Experience" defaultOpen={false}>
                    <div className="flex flex-col gap-8">
                        {experience.map((exp, idx) => (
                            <div key={exp.title + exp.company} className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-6 transition-colors">
                ...
                <CollapsiblePanel title="Education" defaultOpen={false}>
                    <div className="flex flex-col gap-8 mb-4">
                        {education.map((edu) => (
                            <div key={edu.degree + edu.institution} className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-6 transition-colors">
                                <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-2">
