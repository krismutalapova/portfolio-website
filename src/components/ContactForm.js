...
const ContactForm = () => {
    ...
    return (
        <section id="contact" className="w-full max-w-[350px] mx-auto my-12">
            <button
                type="button"
                className="w-full flex items-center justify-between px-8 py-6 text-2xl font-semibold bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white rounded-2xl shadow mb-4 focus:outline-none focus:ring transition-colors"
            ...
            <div id="contact-panel" className={isOpen ? 'block' : 'hidden'}>
                <form onSubmit={handleSubmit} noValidate aria-describedby="form-result" className="bg-white dark:bg-gray-800 rounded-b-2xl shadow px-8 py-6 mt-[-1.5rem]">
                    <div className="mb-4">
